...
public final class XmlStream {
	...
	public static <T> T fromXML(String content, Class<T> clazz) {
		return fromXML(
				new ByteArrayInputStream(content.getBytes(UTF_8)), clazz);
	}
	...
	public static String toXML(Object object) {
		...
		toXML(object, os);
		return os.toByteArray() == null ? null : new String(os.toByteArray(), UTF_8);
	}
	...
	public static void main(String args[]){
		/*MchPayPackage payPackage = new MchPayPackage("商品名称", "100021293232", 20,
				"http://127.0.0.1/notifyUrl", "127.0.0.1", TradeType.JSAPI,
				"ow6YaxLxgshmDCRX34WREf-ECoL0", "123", "1001", null);
		
		System.out.println(XmlStream.toXML(payPackage));*/
	}
}
